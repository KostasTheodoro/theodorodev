...
const en = {
  ...
  'form.fallbackError': 'Something went wrong sending your message — please try again or email me directly.',
...
const el: Record<keyof typeof en, string> = {
  ...
  'hero.subtext':
    'Γρήγορες, σύγχρονες ιστοσελίδες φτιαγμένες να αντέχουν στον χρόνο, με React, Next.js και ό,τι χρειαστεί για να γίνει σωστά η δουλειά. Έχεις μια ιδέα; Είμαι μέσα.',
  'hero.cta': 'Επικοινώνησε',

  'home.workEyebrow': '// work',
  'home.workHeading': 'Η δουλειά μου',
  'home.viewAllProjects': 'Όλα τα έργα',
  'home.aboutEyebrow': '// about',
  'home.aboutHeading': 'Σχετικά',
  'home.aboutTeaser':
  ...
  'meta.about.title': 'Σχετικά — theodorodev',
  'meta.about.description':
    'Ο Κώστας Θεοδωρόπουλος είναι developer με έδρα την Αθήνα και φτιάχνει γρήγορες, προσβάσιμες ιστοσελίδες για ελληνικές μικρές επιχειρήσεις και διεθνείς ομάδες.',
  ...
  'meta.projects.description':
    'Μια επιλογή από ιστοσελίδες φτιαγμένες για μικρές επιχειρήσεις και ομάδες — γρήγορες, προσβάσιμες και με έμφαση στο αποτέλεσμα.',

  'about.heading': 'Σχετικά',
  ...
  'project.year': 'Έτος πρώτης ανάπτυξης:',
  ...
  'form.successToast': 'Το μήνυμα στάλθηκε — ευχαριστώ, θα επικοινωνήσω σύντομα.',
  'form.fallbackError': 'Κάτι πήγε στραβά κατά την αποστολή του μηνύματος — δοκίμασε ξανά ή στείλε μου email απευθείας.',
